...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/panel/comment/user/<?php echo $comment->user_id; ?>/page/1">
        ...
        <ul class="pagination justify-content-center">
            <?php pagination::selector($data->page, "panel/comment/article/{$data->article_id}/"); ?>
        </ul>
    </div>
</div>
